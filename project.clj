(def protojure-version "2.1.1-SNAPSHOT")
...
(defproject io.github.protojure/lib-suite "0.0.1"
  ...
  :managed-dependencies [[org.clojure/clojure "1.11.1"]
                         ...
                         [io.undertow/undertow-servlet "2.2.17.Final"]
                         [io.pedestal/pedestal.log "0.5.10"]
                         [io.pedestal/pedestal.service "0.5.10"]
                         [org.eclipse.jetty.http2/http2-client "11.0.9"]
                         [org.eclipse.jetty/jetty-alpn-java-client "11.0.9"]
